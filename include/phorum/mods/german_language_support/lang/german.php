<?php
    ...
    include(dirname(__FILE__).'/german-alternatives.php');

    // Replacing text from core or module language files with homepage specific texts.
    // Put here the language strings with your own text.

    // Example:
    $PHORUM['DATA']['LANG']['Author'] = 'Autor';
