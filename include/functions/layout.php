...
function add_donate_button($button_nr = 1) {
	...
	echo ("  <input type='image' onclick=\"_paq.push(['trackGoal', 6])\" src='./img/$button' border='0' name='submit' alt='" . _("Donations") . "' title='" . _("Every donation is very welcome and helps the development of OpenHomeopath.") . "'>\n");
	echo ("  <img alt='' border='0' src='https://www.paypal.com/de_DE/i/scr/pixel.gif' width='1' height='1'>\n");
	echo ("</form>\n");
}

function begin_popup($history = 0) {
	echo ("<div id='popup' name='popup' style='position: fixed; display:none; z-index:13;'>\n");
