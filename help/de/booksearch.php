...
/**
 * help/de/booksearch.php
 *
 * The German manual for the booksearch.
 *
...
$head_title = "Buchsuche :: Hilfe :: OpenHomeopath";
$meta_description = "Handbuch für OpenHomeopath, Buchsuche";
if (empty($_GET['popup'])) {
	$skin = $session->skin;
...
<h1>So formulierst Du Suchanfragen für die Buchsuche</h1>
