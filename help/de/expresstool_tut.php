...
/**
 * help/de/expresstool_tut.php
 *
 * The German tutorial for the Expresstool.
 *
...
$head_title = "Expresstool :: Tutorium :: OpenHomeopath";
$meta_description = "Rubriken aus Büchern mit dem Expresstool eingeben";
$meta_keywords = "Expresstool";
$skin = $session->skin;
...
?>
		...
		<style type="text/css" media="all"><!--
			...
			h2{text-align:left;}
		--></style>
<h1>Rubriken aus Büchern mit dem Expresstool eingeben</h1>
...
Die 100 letzten neu eingetragenen Symptom-Rubriken <a href="../../newSymptoms.php">anschauen</a>.
<?php
